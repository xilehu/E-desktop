...
CameraApp::CameraApp(QWidget *parent) : QDialog(parent, Qt::WindowStaysOnTopHint)
{
    initUi();
    initCtrl();
    setModal(true);
...
//    CommonHelper::setStyleSheet(":/misc/CameraApp/style/default.qss", this);
}


void CameraApp::initCtrl()
{
    connect(&m_camScanBtn, &QPushButton::clicked, this, &CameraApp::updateCamInfo);
    connect(&m_switchBtn, &QPushButton::clicked, this, &CameraApp::switchCamBtnClicked);
    connect(&m_takePhotoBtn, &QPushButton::clicked, this, &CameraApp::takePhotoBtnClicked);
    connect(&m_takeVideoBtn, &QPushButton::clicked, this, &CameraApp::takeVedioBtnClicked);
    connect(&m_camResBox, (void(QComboBox::*)(int))&QComboBox::currentIndexChanged, this, &CameraApp::camResBoxChanged);
...
void CameraApp::switchCamBtnClicked()
{
    if (m_camComBox.count() == 0) {
//        SimpleMessageBox::infomationMessageBox("请插入相机后重试");
    ...
    if (m_switchBtn.text() == "打  开") {
        ...
        m_camera->start();
        connect(m_camera.data(), (void(QCamera::*)(QCamera::Error))&QCamera::error, this, &CameraApp::displayCameraError, Qt::UniqueConnection);
...
void CameraApp::takePhotoBtnClicked()
{
...
void CameraApp::displayCameraError()
{
...
void CameraApp::takeVedioBtnClicked()
{
//    SimpleMessageBox::infomationMessageBox("IMX6ULL暂不支持此功能");
}

void CameraApp::camResBoxChanged(int index)
{
...
bool CameraApp::eventFilter(QObject *o, QEvent *e)
{
